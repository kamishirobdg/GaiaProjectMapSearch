...
export const TILE_VALUE_WEIGHTS_LF: TileValueTable = {
  ...
  FEDG5: { terrans: 18, lantids: 18, xenos: 18, gleens: 17, taklons: 18, ambas: 24, hadschHallas: 24, ivits: 24, geodens: 24, balTaks: 18, firaks: 18, bescods: 18, nevlas: 18, itars: 18, moweyds: 18, spaceGiants: 18, tinkerroids: 18, darkanians: 18 }, // 金枠同盟：4VP＋鉱石2＋QIC1
  ...
  FEDG7: { terrans: 14, lantids: 9, xenos: 9, gleens: 9, taklons: 11, ambas: 9, hadschHallas: 9, ivits: 9, geodens: 9, balTaks: 9, firaks: 9, bescods: 9, nevlas: 14, itars: 11, moweyds: 11, spaceGiants: 9, tinkerroids: 9, darkanians: 9 }, // 金枠同盟：7VP＋パワートークン2
