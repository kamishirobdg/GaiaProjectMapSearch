...
export const SHIP_TILE_WEIGHTS_LF: ShipTileTable = {
  FEDG2: { twilight: { moweyds: 24 }, eclipse: { terrans: 18, gleens: 18, balTaks: 23, itars: 18, moweyds: 24, spaceGiants: 18 }, rebellion: { lantids: 18, gleens: 18, taklons: 18, geodens: 18, balTaks: 23, firaks: 18, bescods: 18, nevlas: 18, itars: 18, moweyds: 24, spaceGiants: 18, tinkerroids: 18, darkanians: 18 }, tfmars: { lantids: 18, xenos: 24, taklons: 18, ambas: 24, hadschHallas: 24, geodens: 18, firaks: 18, bescods: 18, nevlas: 18 } },
  TSL3: { tfmars: { terrans: 12, lantids: 12, xenos: 11, gleens: 11, taklons: 11, ambas: 11, hadschHallas: 12, ivits: 11, geodens: 12, balTaks: 11, firaks: 11, bescods: 12, nevlas: 12, itars: 11, moweyds: 11, spaceGiants: 11, tinkerroids: 11, darkanians: 11 } },
  TSL2: { eclipse: { terrans: 12, gleens: 12, moweyds: 12 }, tfmars: { lantids: 18, xenos: 18, taklons: 18, ambas: 18, hadschHallas: 18, geodens: 18, firaks: 18, bescods: 18, nevlas: 18 } },
};
