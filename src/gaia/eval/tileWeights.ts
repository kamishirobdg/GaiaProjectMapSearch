...
export const TILE_VALUE_WEIGHTS_BASE: TileValueTable = {
  ...
  RB03: { terrans: 8, lantids: 8, xenos: 8, gleens: 2, taklons: 12, ambas: 2, hadschHallas: 8, ivits: 2, geodens: 2, balTaks: 8, firaks: 2, bescods: 2, nevlas: 8, itars: 16 }, // 収入：パワートークン2・鉱石1
  ...
  FED8PT: { terrans: 9, lantids: 9, xenos: 11, gleens: 9, taklons: 11, ambas: 9, hadschHallas: 9, ivits: 7, geodens: 9, balTaks: 9, firaks: 9, bescods: 9, nevlas: 11, itars: 11 }, // 同盟：8VP＋パワートークン2
  FED7O: { terrans: 9, lantids: 9, xenos: 9, gleens: 9, taklons: 9, ambas: 9, hadschHallas: 12, ivits: 12, geodens: 11, balTaks: 9, firaks: 9, bescods: 9, nevlas: 9, itars: 9 }, // 同盟：7VP＋鉱石2
  FED7C: { terrans: 9, lantids: 9, xenos: 9, gleens: 9, taklons: 9, ambas: 11, hadschHallas: 14, ivits: 12, geodens: 11, balTaks: 9, firaks: 9, bescods: 9, nevlas: 9, itars: 9 }, // 同盟：7VP＋クレジット6
  FED6K: { terrans: 9, lantids: 11, xenos: 9, gleens: 9, taklons: 9, ambas: 9, hadschHallas: 9, ivits: 11, geodens: 9, balTaks: 9, firaks: 11, bescods: 11, nevlas: 11, itars: 9 }, // 同盟：6VP＋知識2
};

/** ★拡張版（18種族）。CSV から生成。 */
export const TILE_VALUE_WEIGHTS_LF: TileValueTable = {
  // ===== ブースター =====
  RB01: { terrans: 8, lantids: 4, xenos: 4, gleens: 4, taklons: 4, ambas: 4, hadschHallas: 8, ivits: 6, geodens: 6, balTaks: 4, firaks: 4, bescods: 6, nevlas: 8, itars: 4, moweyds: 3, spaceGiants: 4, tinkerroids: 4, darkanians: 3 }, // 収入：鉱石1・知識1
  RB02: { terrans: 10, lantids: 12, xenos: 16, gleens: 8, taklons: 10, ambas: 16, hadschHallas: 16, ivits: 16, geodens: 10, balTaks: 16, firaks: 16, bescods: 10, nevlas: 10, itars: 16, moweyds: 2, spaceGiants: 2, tinkerroids: 2, darkanians: 2 }, // 収入：クレジット2・QIC1
  RB03: { terrans: 8, lantids: 8, xenos: 8, gleens: 2, taklons: 12, ambas: 2, hadschHallas: 8, ivits: 2, geodens: 2, balTaks: 8, firaks: 2, bescods: 2, nevlas: 8, itars: 16, moweyds: 2, spaceGiants: 2, tinkerroids: 2, darkanians: 2 }, // 収入：パワートークン2・鉱石1
  RB04: { terrans: 3, lantids: 4, xenos: 4, gleens: 3, taklons: 3, ambas: 3, hadschHallas: 8, ivits: 3, geodens: 12, balTaks: 3, firaks: 3, bescods: 3, nevlas: 3, itars: 3, moweyds: 3, spaceGiants: 4, tinkerroids: 3, darkanians: 4 }, // 収入：クレジット2／特別：鉱山建設（改造1無料）
  RB05: { terrans: 4, lantids: 3, xenos: 3, gleens: 16, taklons: 10, ambas: 3, hadschHallas: 3, ivits: 8, geodens: 3, balTaks: 16, firaks: 3, bescods: 3, nevlas: 10, itars: 4, moweyds: 3, spaceGiants: 3, tinkerroids: 3, darkanians: 4 }, // 収入：パワー2／特別：鉱山建設orガイア計画（距離+3）
  RB06: { terrans: 6, lantids: 9, xenos: 8, gleens: 9, taklons: 6, ambas: 6, hadschHallas: 6, ivits: 6, geodens: 9, balTaks: 6, firaks: 6, bescods: 9, nevlas: 6, itars: 6, moweyds: 6, spaceGiants: 8, tinkerroids: 6, darkanians: 8 }, // 収入：鉱石1／パス：鉱山×1VP
  ...
  RB09: { terrans: 16, lantids: 16, xenos: 10, gleens: 8, taklons: 20, ambas: 16, hadschHallas: 16, ivits: 20, geodens: 16, balTaks: 10, firaks: 16, bescods: 8, nevlas: 20, itars: 16, moweyds: 10, spaceGiants: 8, tinkerroids: 12, darkanians: 8 }, // 収入：パワー4／パス：学院・首府×4VP
  RB10: { terrans: 12, lantids: 4, xenos: 4, gleens: 12, taklons: 4, ambas: 4, hadschHallas: 5, ivits: 8, geodens: 4, balTaks: 8, firaks: 4, bescods: 4, nevlas: 4, itars: 8, moweyds: 4, spaceGiants: 4, tinkerroids: 4, darkanians: 4 }, // 収入：クレジット4／パス：ガイア惑星×1VP
  ...
  // ===== 最終得点 =====
  FS01: { terrans: 10, lantids: 10, xenos: 12, gleens: 10, taklons: 10, ambas: 15, hadschHallas: 10, ivits: 18, geodens: 10, balTaks: 10, firaks: 10, bescods: 10, nevlas: 10, itars: 10, moweyds: 12, spaceGiants: 10, tinkerroids: 10, darkanians: 10 }, // 同盟内の建造物 最多
  FS02: { terrans: 10, lantids: 15, xenos: 12, gleens: 10, taklons: 12, ambas: 12, hadschHallas: 10, ivits: 8, geodens: 10, balTaks: 10, firaks: 10, bescods: 10, nevlas: 10, itars: 10, moweyds: 10, spaceGiants: 12, tinkerroids: 10, darkanians: 12 }, // 建造物 最多
  ...
  FS04: { terrans: 14, lantids: 9, xenos: 9, gleens: 14, taklons: 9, ambas: 9, hadschHallas: 9, ivits: 14, geodens: 9, balTaks: 12, firaks: 9, bescods: 9, nevlas: 9, itars: 14, moweyds: 9, spaceGiants: 7, tinkerroids: 7, darkanians: 7 }, // ガイア惑星 最多
  FS05: { terrans: 10, lantids: 20, xenos: 12, gleens: 10, taklons: 12, ambas: 14, hadschHallas: 10, ivits: 5, geodens: 10, balTaks: 5, firaks: 10, bescods: 10, nevlas: 10, itars: 10, moweyds: 10, spaceGiants: 10, tinkerroids: 10, darkanians: 15 }, // 入植宙域 最多
  FS06: { terrans: 15, lantids: 12, xenos: 6, gleens: 9, taklons: 15, ambas: 15, hadschHallas: 12, ivits: 6, geodens: 12, balTaks: 9, firaks: 12, bescods: 15, nevlas: 9, itars: 6, moweyds: 9, spaceGiants: 9, tinkerroids: 9, darkanians: 9 }, // 衛星 最多
  ...
  FED8PT: { terrans: 9, lantids: 9, xenos: 11, gleens: 9, taklons: 11, ambas: 9, hadschHallas: 9, ivits: 7, geodens: 9, balTaks: 9, firaks: 9, bescods: 9, nevlas: 11, itars: 11, moweyds: 11, spaceGiants: 9, tinkerroids: 9, darkanians: 9 }, // 同盟：8VP＋パワートークン2
  FED7O: { terrans: 9, lantids: 9, xenos: 9, gleens: 9, taklons: 9, ambas: 9, hadschHallas: 12, ivits: 12, geodens: 11, balTaks: 9, firaks: 9, bescods: 9, nevlas: 9, itars: 9, moweyds: 9, spaceGiants: 11, tinkerroids: 11, darkanians: 9 }, // 同盟：7VP＋鉱石2
  FED7C: { terrans: 9, lantids: 9, xenos: 9, gleens: 9, taklons: 9, ambas: 11, hadschHallas: 14, ivits: 12, geodens: 11, balTaks: 9, firaks: 9, bescods: 9, nevlas: 9, itars: 9, moweyds: 9, spaceGiants: 9, tinkerroids: 9, darkanians: 11 }, // 同盟：7VP＋クレジット6
  FED6K: { terrans: 9, lantids: 11, xenos: 9, gleens: 9, taklons: 9, ambas: 9, hadschHallas: 9, ivits: 11, geodens: 9, balTaks: 9, firaks: 11, bescods: 11, nevlas: 11, itars: 9, moweyds: 9, spaceGiants: 9, tinkerroids: 9, darkanians: 9 }, // 同盟：6VP＋知識2
  // ===== LF船 =====
