...
export const ROUND_SCORING_WEIGHTS_LF: RoundScoringTable = {
  ...
  // RS03 交易所建設 +4VP
  RS03: [
    { terrans: 4, lantids: 4, xenos: 4, gleens: 4, taklons: 4, ambas: 4, hadschHallas: 8, ivits: 4, geodens: 4, balTaks: 4, firaks: 8, bescods: 8, nevlas: 8, itars: 8, moweyds: 7, spaceGiants: 7, tinkerroids: 7, darkanians: 7 }, // R1
