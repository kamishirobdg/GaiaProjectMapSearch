...
TILE_VP = {
    ...
    "AT04": 14,  # 鉱山×2VP … 鉱山7個
    "AT06": 5,   # 宙域×鉱石1 … 宙域4 → 鉱石4（資源なのでVPは低め）
    "AT08": 6,   # ガイア惑星×2VP … ガイア3個
    "AT09": 12,  # 交易所×4VP … 交易所3個
    "AT10": 8,   # 宙域×2VP … 宙域4
    "AT12": 10,  # 同盟タイル×5VP … 同盟2枚
    "AT16": 12,  # 首府・学院×6VP … 首府1＋学院1（LF）
    "AT17": 8,   # 深宇宙宙域×4VP … 深宇宙2（LF）
    # --- アクション: 取得後およそ3ラウンド、毎ラウンド1回 ---
    "AT03": 9,   # QIC1＋クレ5 … 3回で QIC3＋クレ15
    "AT07": 9,   # 鉱石3 … 3回で鉱石9
    "AT13": 11,  # 知識3 … 3回で知識9（研究に直結するぶん高め）
    # --- パス時: 取得後およそ3回パスする ---
    "AT01": 16,  # 同盟タイル×3VP … 同盟2〜3枚×3回（揃うのが後半なので割引）
    "AT05": 18,  # 研究所×3VP … 研究所2個×3回
    "AT15": 15,  # 惑星種類×1VP … 種類5×3回
    "AT18": 12,  # 小惑星×2VP … 小惑星2×3回（LF）
    "AT21": 12,  # 深宇宙宙域×2VP … 深宇宙2×3回（LF）
    # --- 誘発（〜するたび）: 取得後に何回起きるか ---
    "AT02": 16,  # 研究を進めるたび+2VP … 取得後8回
    "AT11": 6,   # 交易所を建設するたび+3VP … 取得後2個（終盤は建て替えが主）
    "AT14": 9,   # 鉱山を建設するたび+3VP … 取得後3個
    "AT19": 12,  # 惑星改造1段階ごと+2VP … 取得後6段階（LF）
    "AT20": 12,  # QICアクションのたび+4VP … 取得後3回（LF）
}
