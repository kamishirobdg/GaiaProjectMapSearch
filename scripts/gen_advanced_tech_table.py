...
TILE_VP = {
    ...
    # --- アクション: **R4 に取れば R4/R5/R6 の3回起動できる**（取得したラウンド中に
    #     もう使えるため。収入タイルは R4 取得だと R5/R6 の2回しか入らない）。
    #     2026-08-06 にアクションを1つ消費するぶんの割引をやめ、標準技術の収入タイルと
    #     **同じレート**で素直に換算し直した（鉱石1=1.0 / クレ1=0.4 / 知識1=1.5 /
    #     QIC1=1.5 / パワー1=0.5。gen_tech_position_table.py と共通）。
    "AT03": 15,  # (10.5+4) QIC1＋クレ5 … (1×1.5＋5×0.4)×3回 ＝ 10.5
    "AT07": 13,  # (9.0+4)  鉱石3 … 3×1.0×3回 ＝ 9.0
    "AT13": 18,  # (13.5+4) 知識3 … 3×1.5×3回 ＝ 13.5
